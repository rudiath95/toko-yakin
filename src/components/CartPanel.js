        ...
        <div class="px-3 md:px-5 pt-6 pb-3 border-b border-gray-700/80">
          <h2 class="text-xl font-bold flex items-center gap-2">
            ...
            <div class="ml-auto flex items-center gap-1">
              <button class="text-xs font-medium text-white bg-green-700 hover:bg-green-600 px-2 py-1 rounded-md transition" :title="'Add custom product (' + store.getShortcutKey('customProd') + ')'" @click="openCustomProduct" data-no-search-focus>
              ...
              <button class="text-xs font-medium text-emerald-300 hover:text-white bg-emerald-700/50 hover:bg-emerald-600 px-2 py-1 rounded-md transition" :title="'Save cart as new entry (' + store.getShortcutKey('saveCart') + ')'" @click="store.saveNamedCart()">
              ...
              <button class="text-xs font-medium text-blue-300 hover:text-white bg-blue-700/50 hover:bg-blue-600 px-2 py-1 rounded-md transition" :title="'Browse saved carts (' + store.getShortcutKey('loadCart') + ')'" @click="store.openSavedCarts()">
              ...
              <button class="text-xs font-normal text-red-400 hover:text-red-300 bg-gray-700/50 hover:bg-red-900/50 px-2.5 py-1 rounded-md transition flex items-center gap-1" :title="'Clear all (' + store.getShortcutKey('clearCart') + ')'" @click="onClearCart">
